...
export default function AboutPage() {
  return (
    <div className="pt-32 pb-20 w-[90%] md:w-[85%] mx-auto min-h-screen">
      <h1 className="text-5xl font-bold mb-8 text-slate-900">About Veluxeride</h1>
      <p className="text-xl text-slate-500 max-w-3xl leading-relaxed mb-16">
        Veluxeride is reimagining urban mobility in Nigeria. We believe that transportation should be reliable, affordable, and accessible to everyone. By connecting passengers with drivers already heading in the same direction, we are reducing congestion, lowering costs, and building a community of trust.
      </p>
