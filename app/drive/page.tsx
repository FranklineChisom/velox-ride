      ...
      <div className="w-[90%] md:w-[85%] mx-auto">
        <section className="mb-24">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1 h-[500px] rounded-3xl overflow-hidden shadow-2xl">
              <img src="https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?q=80&w=2940" className="object-cover w-full h-full" alt="Driver" />
            </div>
            <div className="order-1 md:order-2">
              ...
              <Link href="/auth?role=driver" className="inline-flex items-center px-8 py-4 bg-black text-white rounded-full font-bold text-lg hover:bg-slate-800 transition">
                Sign up to drive
              </Link>
            </div>
          </div>
        ...
        <section className="bg-black text-white p-12 rounded-3xl mb-24">
