  ...
  return (
    <div className="pt-32 pb-20 w-[90%] md:w-[85%] mx-auto max-w-3xl min-h-screen">
      ...
      <div className="prose prose-slate prose-lg">
        ...
        <p className="mb-6">Welcome to Veluxeride. By using our app, you agree to these terms...</p>
        ...
        <p className="text-slate-600 mb-6">Veluxeride provides a technology platform that enables users of Veluxeride&apos;s mobile applications or websites to arrange and schedule transportation and/or logistics services with independent third party providers of such services.</p>
